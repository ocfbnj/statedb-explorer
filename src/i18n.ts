...
const en: Record<string, string> = {
  ...
  'nav.schema': 'Schema',
  'nav.sql': 'SQL',
  'nav.apiRecords': 'API Records',
  'nav.settings': 'Settings',

  // API Records page
  'api.pageTitle': '📡 API Records',
  'api.pageSubtitle': '{n} calls recorded',
  'api.noHook': 'API Hook Not Available',
  'api.noHookDesc': 'Enable the api_hook plugin to record LLM API requests and responses.',
  'api.selectSession': 'Select a session',
  'api.selectDesc': 'Choose a session to view its API calls.',
  'api.noCalls': 'No API Calls',
  'api.noCallsDesc': 'No API calls recorded for this session yet.',
  'api.input': 'in',
  'api.output': 'out',
  'api.total': 'total',
  'api.cache': 'cache',
  ...
  'api.callId': 'ID',
  'api.copyId': 'Click to copy API request ID',
  'api.mode': 'Mode',
  'api.retries': 'Retries',
  'api.duration': 'Duration',
  'api.hitRate': 'cache hit {pct}%',
  'api.tooltipHitRate': 'Cache hit rate: share of the prompt served from cache (higher = cheaper)',
  'api.checking': 'Checking api_hook availability…',
  'api.loading': 'Loading API calls…',
...
const zh: Record<string, string> = {
  ...
  'nav.schema': '表结构',
  'nav.sql': 'SQL',
  'nav.apiRecords': 'API 请求记录',
  'nav.settings': '设置',

  // API Records page
  'api.pageTitle': '📡 API 请求记录',
  'api.pageSubtitle': '{n} 次调用',
  'api.noHook': 'API 插件未启用',
  'api.noHookDesc': '启用 api_hook 插件以记录 LLM API 请求和响应。',
  'api.selectSession': '选择会话',
  'api.selectDesc': '选择一个会话查看其 API 调用记录。',
  'api.noCalls': '暂无 API 调用',
  'api.noCallsDesc': '该会话暂无 API 调用记录。',
  'api.input': '入',
  'api.output': '出',
  'api.total': '总计',
  'api.cache': '缓存',
  ...
  'api.response': '响应',
  'api.callId': '编号',
  'api.copyId': '点击复制 API 请求 ID',
  'api.mode': '模式',
  'api.retries': '重试',
  'api.duration': '耗时',
  'api.hitRate': '缓存命中 {pct}%',
  'api.tooltipHitRate': '缓存命中率：提示词中由缓存提供的比例（越高越省钱）',
  'api.checking': '检查 api_hook 插件状态…',
  'api.loading': '加载 API 调用中…',
