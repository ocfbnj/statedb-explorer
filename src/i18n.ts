...
const en: Record<string, string> = {
  ...
  'msg.apiReqResp': 'Request/Response',
  'msg.viewApiCall': 'View the real API request/response for this message',
  'msg.apiNone': 'No record',
...
const zh: Record<string, string> = {
  ...
  'msg.reasoning': '推理过程',
  'msg.rawData': '原始数据',
  'msg.apiReqResp': '请求/响应',
  'msg.viewApiCall': '查看这条消息对应的真实 API 请求/响应',
  'msg.apiNone': '无记录',
  'msg.empty': '(空消息)',
